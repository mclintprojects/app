...
export default {
  ...
  db_password: "Passwort Datenbank-Benutzer",
  ...
  delete_collection_are_you_sure:
    "Soll diese Kollektion wirklich gelöscht werden?? Diese Aktion kann nicht rückgängig gemacht werden.",
  ...
  delete_bookmark: "Bookmark löschen",
  delete_bookmark_body:
    "Soll das Bookmark wirklich gelöscht werden? Diese Aktion kann nicht rückgängig gemacht werden.",
  ...
  enter_role_name: "Rolennamen eingeben...",
  environment: "Umgebung",
  errors: {
    "-1": "API kann nicht erreicht werden",
    11: "Keine Datenbankverbindung",
    100: "Falscher Benutzername und/oder Passwort",
    101: "Logged out aufgrund von Inaktivität",
    102: "Logged out aufgrund von Inaktivität",
  ...
  event_count: "Keine Events | Ein Event | {count} Events",
  ...
  dont_manage_copy:
    "Berechtigungen und Einstellungen der Kollektion {collection} werden endgültig vom System gelöscht! Bist Du sicher?",
  ...
  settings_interface: "Interface Einstellungen",
  settings_global: "Globale Einstellungen",
  settings_collections_fields: "Kollektionen & Felder",
